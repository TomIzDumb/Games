...
gdjs.WarningCode.asyncCallback15591284 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2.3), (runtimeScene) => (gdjs.WarningCode.asyncCallback15591284(runtimeScene, asyncObjectsList)));
}
}
...
{gdjs.evtTools.window.setFullScreen(runtimeScene, true, true);
    ...
    gdjs.WarningCode.GDBlackObjects1[i].setOpacity(0);
}
