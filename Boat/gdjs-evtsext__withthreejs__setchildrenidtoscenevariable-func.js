...
gdjs.evtsExt__WithThreeJS__SetChildrenIdToSceneVariable.userFunc0xc51190 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
const VariableName = eventsFunctionContext.getArgument("Variable");
//
...
runtimeScene.getVariables().get(VariableName).fromJSObject(Children);
...
gdjs.evtsExt__WithThreeJS__SetChildrenIdToSceneVariable.userFunc0xc51190(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
